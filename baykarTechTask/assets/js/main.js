$(document).ready(function () {
  ...
  const arrowSvg =
    '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" class="ms-4">' +
  ...
  takeActiveTab();
  var orgText;
  function takeActiveTab() {
    var activeTab = $(".slide-link.nav-link.active");
    var text = activeTab.html();
    orgText = text;
    text += arrowSvg;
    activeTab.html(text);
  }
  $(".slide-link.nav-link").click(function () {
    $(".slide-link.nav-link.active").html(orgText);
    orgText = $(this).html();
    $(".slide-link.nav-link.active").removeClass("active");
